...
public class RoomDataComposite extends Composite implements DataComposite
{
	...
	public RoomDataComposite( Composite parent, RoomController control )
	{
		...
		{
//			Label lblCrewInRoom = new Label( this, SWT.NONE );
//			lblCrewInRoom.setText( "Preset crew member(s):" );
//			ArrayList<Button> btnCrewMembers = new ArrayList<Button>();
//			Composite comp = this;
//			final CrewMenu crewMenu = new CrewMenu(comp);
...
//				}};
//
//			for ( int i = 0; i < container.getActiveSystem( roomC.getGameObject()).getRoom().getSize().x * container.getActiveSystem( roomC.getGameObject()).getRoom().getSize().y; i++ ) {
...
//			GridData gd_txtCrewInRoom = new GridData( SWT.RIGHT, SWT.CENTER, false, false, 1, 1 );
//			gd_txtCrewInRoom.widthHint = 20;
//			txtMaxLevel.setLayoutData( gd_txtCrewInRoom );
		}
