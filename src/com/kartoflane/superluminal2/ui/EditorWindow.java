...
public class EditorWindow
{
	...
	public EditorWindow( Display display )
	{
		...
		// Load icons
		Image icon16 = Cache.checkOutImage( shell, "cpath:/resources/assets/icons/Superluminal_2_16.png" );
		Image icon24 = Cache.checkOutImage( shell, "cpath:/resources/assets/icons/Superluminal_2_24.png" );
		Image icon32 = Cache.checkOutImage( shell, "cpath:/resources/assets/icons/Superluminal_2_32.png" );
		Image icon48 = Cache.checkOutImage( shell, "cpath:/resources/assets/icons/Superluminal_2_48.png" );
		Image icon64 = Cache.checkOutImage( shell, "cpath:/resources/assets/icons/Superluminal_2_64.png" );
		Image icon128 = Cache.checkOutImage( shell, "cpath:/resources/assets/icons/Superluminal_2_128.png" );
		...
		tltmPointer.setImage( Cache.checkOutImage( this, "cpath:/resources/assets/pointer.png" ) );
		...
		tltmCreation.setImage( Cache.checkOutImage( this, "cpath:/resources/assets/wrench.png" ) );
		...
		tltmImages.setImage( Cache.checkOutImage( this, "cpath:/resources/assets/images.png" ) );
		...
		tltmProperties.setImage( Cache.checkOutImage( this, "cpath:/resources/assets/system.png" ) );
		...
		tltmManager.setImage( Cache.checkOutImage( this, "cpath:/resources/assets/overview.png" ) );
		...
		tltmCloak.setImage( Cache.checkOutImage( this, "cpath:/resources/assets/cloak.png" ) );
	...
	public void updateGibAnimationButton( boolean animate )
	{
		if ( animate ) {
			...
			tltmAnimate.setImage( Cache.checkOutImage( this, "cpath:/resources/assets/play.png" ) );
			Hotkey h = Manager.getHotkey( Hotkeys.ANIMATE );
			tltmAnimate.setToolTipText( "Animate Gibs" + ( h.isEnabled() ? String.format( " (%s)", h.toString() ) : "" ) );
		}
		else {
			Cache.checkInImage( this, "cpath:/resources/assets/play.png" );
			tltmAnimate.setImage( Cache.checkOutImage( this, "cpath:/resources/assets/stop.png" ) );
			Hotkey h = Manager.getHotkey( Hotkeys.ANIMATE );
